...
$infobox_content[] = array(
    ...
    'eintrag'   => array(
        array(
            ...
            'text' => _('Nutzer/innen erhalten automatisch Zugriff auf dieses Aufgabenset, wenn sie in eine der ausgewählten Studiengangskombinationen studieren.')
        )
    )
);
...
<form method="post" action="<?= $controller->url_for('admin/set/add') ?>">
    ...
    <label>
        ...
        <textarea name="description" class="add_toolbar"></textarea><br>
    </label>
    <br>
